                                    ...
                                    <div class="form-group">
                                        <select class="form-control bm-select2" id="bm-filter-customer"
                                            ...
                                            <?php foreach ($customers as $customer) { ?>
                                                <option value="<?php echo esc_attr($customer['id']) ?>"><?php esc_html_e($customer['full_name']) ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <select class="form-control bm-select2" id="bm-filter-employee"
                                            ...
                                            <?php foreach ($employees as $staff) { ?>
                                                <option value="<?php echo esc_attr($staff['id']) ?>"><?php esc_html_e($staff['full_name']) ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <select class="form-control bm-select2" id="bm-filter-service"
                                            ...
                                            <?php foreach ($services as $service) { ?>
                                                <option value="<?php echo esc_attr($service['id']) ?>"><?php esc_html_e($service['title']) ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <table class="table table-striped" id="bm-bookings-table">
                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($custom_fields as $custom_field) { ?>
                                            <th class="none"><?php echo wp_kses_post($custom_field->label) ?></th>
                                        <?php } ?>
                                        <th width="20"></th>
                                        <th width="20">
                                            <div class="checkbox">
