                        ...
                        if ($notification['to_customer']) {
                            ...
                            <div class="card bookme-card">
                                <div class="card-header d-flex align-items-center">
                                    <input name="notification[<?php echo esc_attr($id) ?>][active]" value="0"
                                           type="hidden">
                                    <label class="switch switch-sm m-r-10">
                                        <input name="notification[<?php echo esc_attr($id) ?>][active]" type="checkbox"
                                               id="active_<?php echo esc_attr($id) ?>"
                                               value="1" <?php checked($notification['active']) ?>>
                                        <span class="switch-state"></span>
                                    </label>
                                    <h5 class="mb-0">
                                        <button class="btn btn-link pl-0" data-toggle="collapse"
                                                data-target="#notification_<?php echo esc_attr($id) ?>"
                                                aria-expanded="false" aria-controls="notification_<?php echo esc_attr($id) ?>"
                                                type="button">
                                ...
                                <div class="collapse" id="notification_<?php echo esc_attr($id) ?>"
                                     aria-labelledby="notification_<?php echo esc_attr($id) ?>" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                    <label for="notification_subject_<?php echo esc_attr($id) ?>"><?php esc_html_e('Subject', 'bookme') ?></label>
                                                    <input type="text" class="form-control"
                                                           id="notification_subject_<?php echo esc_attr($id) ?>"
                                                           name="notification[<?php echo esc_attr($id) ?>][subject]"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="notification_time_<?php echo esc_attr($id) ?>"><?php esc_html_e('Sending Time', 'bookme') ?></label>
                                                    <select class="form-control"
                                                            id="notification_time_<?php echo esc_attr($id) ?>"
                                                            name="<?php echo esc_attr($notification['type']) ?>_cron_hour">
                            ...
                            <div class="card bookme-card">
                                ...
                                <div class="collapse" id="notification_<?php echo esc_attr($id) ?>"
                                    ...
                                    <?php } ?>
                                        ...
                                        <div class="form-group">
                                            <input name="notification[<?php echo esc_attr($id) ?>][to_admin]" type="hidden"
                                                   value="0">
                                            <label class="switch switch-sm m-r-10">
                                                <input name="notification[<?php echo esc_attr($id) ?>][to_admin]" type="checkbox"
                                                       id="notification_<?php echo esc_attr($id) ?>_to_admin"
                                                       value="1" <?php checked($notification['to_admin']) ?>>
                                                <span class="switch-state"></span>
                                            </label>
                                            <label class="m-b-0"
                                                   for="notification_<?php echo esc_attr($id) ?>_to_admin"><?php esc_html_e('Send a copy to admin', 'bookme') ?></label>
                                        </div>
                                        <?php switch ($notification['type']) {
                                            case 'staff_agenda':
