...
<div class="m-t-5 schedule-break bm-break-<?php echo esc_attr($break['id']) ?>" data-break-id="<?php echo esc_attr($break['id']) ?>">
    <div class="btn-group btn-group-sm">
        <button type="button"
                class="btn btn-sm btn-primary bm-schedule-break"
                data-popover-content=".bookme-break-content-<?php echo esc_attr($break['id']) ?>">
    ...
    <div class="bookme-break-content-<?php echo esc_attr($break['id']) ?> hidden">
        <div class="input-group m-b-10 theme-form">
            <select class="form-control break-start"
                    data-id="<?php echo esc_attr($break['staff_schedule_id']) ?>">
        ...
        <div>
            <button class="btn-icon btn-primary ajax-save-break"
                    title="<?php esc_attr_e('Save', 'bookme') ?>" data-break-id="<?php echo esc_attr($break['id']) ?>">
