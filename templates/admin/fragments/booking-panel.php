                                    ...
                                    <div class="form-group form-required">
                                        ...
                                        <select id="bookme-staff" class="form-control">
                                            <?php foreach ($staff as $staff_member) { ?>
                                                <option value="<?php echo esc_attr($staff_member['id']) ?>"><?php echo esc_html($staff_member['full_name']) ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div id="bookme-time">
                                            ...
                                            <select id="bookme-start-time" class="form-control">
                                                <?php foreach ($start_time as $time) { ?>
                                                    <option value="<?php echo esc_attr($time['value']) ?>"><?php echo esc_html($time['title']) ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
