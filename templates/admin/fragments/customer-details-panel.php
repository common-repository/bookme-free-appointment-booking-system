                            ...
                            <div id="bookme-custom-fields-wrapper">
                                ...
                                <?php foreach ($custom_fields as $custom_field) { ?>
                                    <div class="form-group"
                                        ...
                                        <label for="custom_field_<?php echo esc_attr($custom_field->id) ?>"><?php echo esc_html($custom_field->label) ?></label>
                                        <div>
                                            ...
                                            <?php } elseif ($custom_field->type == 'checkboxes') { ?>
                                                <?php foreach ($custom_field->items as $i => $item) {
                                                    ...
                                                    <div class="checkbox m-b-10">
                                                        <input type="checkbox" id="check_<?php echo esc_attr($id) ?>" value="<?php echo esc_attr($item) ?>"
                                                               class="bookme-custom-field">
                                                        <label for="check_<?php echo esc_attr($id) ?>"><span class="checkbox-icon"></span> <?php echo esc_attr($item) ?></label>
                                                    </div><br>
                                                <?php } ?>
                                            ...
                                            <?php } elseif ($custom_field->type == 'radio-buttons') { ?>
                                                <?php foreach ($custom_field->items as $item) { ?>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio"
                                                                   name="<?php echo esc_attr($custom_field->id) ?>"
                                                                   class="bookme-custom-field"
