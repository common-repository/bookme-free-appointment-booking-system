...
<div class="bookme-page-wrapper">
                            ...
                            <div class="bookme-card card all-services-box">
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right">
                                        <button type="button" data-url="<?php echo esc_url($service_panel_url) ?>"
    ...
    <div class="site-action">
        ...
        <button type="button" class="front-icon btn btn-primary btn-floating" data-url="<?php echo esc_url($service_panel_url); ?>" data-toggle="slidePanel">
