    ...
    <table class="table table-striped">
        ...
        <?php foreach ($services as $service) { ?>
            <tr data-service-id="<?php echo esc_attr($service['id']) ?>">
                <td>
                    <div class="checkbox">
                        <input type="checkbox" id="check_<?php echo esc_attr($service['id']) ?>" value="<?php echo esc_attr($service['id']) ?>" class="bm-check">
                        <label for="check_<?php echo esc_attr($service['id']) ?>"><span class="checkbox-icon"></span></label>
                    </div>
                </td>
                <td>
