        ...
        <table class="table table-bordered">
            ...
            <?php foreach ($items as $item) { ?>
                <tr>
                    ...
                    <td>
                        <?php if ($item['number_of_persons'] > 1) echo esc_html($item['number_of_persons']) . '&nbsp;&times;&nbsp;' ?><?php echo esc_html($item['service_name']) ?>
                    </td>
            ...
            <tr>
                <th colspan="2">
                    ...
                    <?php if ($payment['coupon']) { ?>
                        <div>
                        <small>(<?php echo esc_html($payment['coupon']['code']) ?>)</small></div><?php } ?>
                </th>
                <th class="text-right">
                    <?php if ($payment['coupon']) { ?>
                        <?php if ($payment['coupon']['discount']) { ?>
                            <div>-<?php echo esc_html($payment['coupon']['discount']) ?>%</div>
                        <?php } ?>
