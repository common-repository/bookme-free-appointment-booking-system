...
class Employees extends Inc\Core\App
{
    ...
    public function execute()
    {
        ...
        Inc\Core\Template::create('employees/page')->display(compact('employees', 'add_employee_panel_url', 'edit_employee_panel_url', 'edit_holidays_panel_url'));
    }
    ...
    {
        global $wpdb;
        if($wpdb->get_var("SELECT COUNT(*) FROM `" . Inc\Mains\Tables\Employee::get_table_name() . "`") > 2){
            wp_send_json_error(array( 'message' => Fragments::get_limitation_html()));
        }
