...
abstract class Request
{
    ...
    {
        return self::has_parameter($name) ? stripslashes_deep(wp_kses_post_deep($_REQUEST[$name])) : $default;
    }
    ...
    {
        return stripslashes_deep(wp_kses_post_deep($_REQUEST));
    }
    ...
    {
        return stripslashes_deep(wp_kses_post_deep($_POST));
    }
