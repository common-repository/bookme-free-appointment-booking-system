...
abstract class System
{
    ...
    public static function get_current_page_url()
    {
        ...
        $url .= isset($_SERVER['HTTP_X_FORWARDED_HOST']) ? filter_var($_SERVER['HTTP_X_FORWARDED_HOST']) : filter_var($_SERVER['HTTP_HOST']);

        return esc_url($url . $_SERVER['REQUEST_URI']);
    }
    ...
    public static function shortcodes(array $codes, $flags = array())
    {
        ...
        echo wp_kses_post("<div class='bm-shortcode-wrapper'>$tpl</div>");
    }
